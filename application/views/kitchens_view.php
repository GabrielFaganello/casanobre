       ...
       <div class="container bg-dark">
            ...
            <div class="row row-margins-ambiente">
                <div class="col-md-offset-1 col-md-5 col-margins-ambiente">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/7.jpg" class="img-responsive hover-shadow" alt="Cozinha_7" onclick="openModal();currentSlide(7)">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/8.jpg" class="img-responsive hover-shadow" alt="Cozinha_8" onclick="openModal();currentSlide(8)">
                    </div>
                </div>
            </div>
            ...
            <div class="row row-margins-ambiente">
                <div class="col-md-offset-1 col-md-5 col-margins-ambiente">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/9.jpg" class="img-responsive hover-shadow" alt="Cozinha_9" onclick="openModal();currentSlide(9)">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/10.jpg" class="img-responsive hover-shadow" alt="Cozinha_10" onclick="openModal();currentSlide(10)">
                    </div>
                </div>
            </div>
            ...
            <div class="row row-margins-ambiente">
                <div class="col-md-offset-1 col-md-5 col-margins-ambiente">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/11.jpg" class="img-responsive hover-shadow" alt="Cozinha_11" onclick="openModal();currentSlide(11)">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/12.jpg" class="img-responsive hover-shadow" alt="Cozinha_12" onclick="openModal();currentSlide(12)">
                    </div>
                </div>
            </div>
            ...
            <div class="row row-margins-ambiente">
                <div class="col-md-offset-1 col-md-5 col-margins-ambiente">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                          <img src="resources/img/<?=$folder?>/13.jpg" class="img-responsive hover-shadow" alt="Cozinha_13" onclick="openModal();currentSlide(13)">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/14.jpg" class="img-responsive hover-shadow" alt="Cozinha_14" onclick="openModal();currentSlide(14)">
                    </div>
                </div>
            </div>
            ...
            <div class="row row-margins-ambiente">
                <div class="col-md-offset-1 col-md-5 col-margins-ambiente">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/15.jpg" class="img-responsive hover-shadow" alt="Cozinha_15" onclick="openModal();currentSlide(15)">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/16.jpg" class="img-responsive hover-shadow" alt="Cozinha_16" onclick="openModal();currentSlide(16)">
                    </div>
                </div>
            </div>
            ...
            <div class="row row-margins-ambiente">
                <div class="col-md-offset-1 col-md-5 col-margins-ambiente">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/17.jpg" class="img-responsive hover-shadow" alt="Cozinha_17" onclick="openModal();currentSlide(17)">
                    </div>
                </div>
                <div class="col-md-5">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/18.jpg" class="img-responsive hover-shadow" alt="Cozinha_18" onclick="openModal();currentSlide(18)">
                    </div>
                </div>
            </div>
            ...
            <div class="row row-margins-ambiente">
                <div class="col-md-offset-3 col-md-6 col-margins-ambiente">
                    <div class="item-img-wrap">
                        <div class="img-responsive"></div>
                         <img src="resources/img/<?=$folder?>/19.jpg" class="img-responsive hover-shadow" alt="Cozinha_19" onclick="openModal();currentSlide(19)">
                    </div>
                </div>
            </div>
    ...
    <section class="main-ambiente" id="home" style="padding: 0px">
        <div class="row text-center" style="margin: 0px !important; padding: 0px !important;">
            <div class="col-md-8 col-md-offset-2">
                <img src="resources/img/NobrezaNasAtitudesWite.png" style="height: 150px !important; margin-top: 25px">
            </div>
        </div>
